...
import com.david.wedis.channel.single.SingleSelectChannelOption;
import com.david.wedis.aof.Aof;
import com.david.wedis.util.PropertiesUtil;
 ...
 */
public class WedisServerImp implements WedisServer
{
    private static final Logger LOGGER = Logger.getLogger(WedisServerImp.class);
    private final WedisCore redisCore =  new WedisCoreImpl();
    private final ServerBootstrap serverBootstrap=new ServerBootstrap();
    private final  EventExecutorGroup redisSingleEventExecutor;
    private final LocalChannelOption channelOption;
    private Aof aof;
    public WedisServerImp()
    {
        channelOption=new DefaultChannelSelectStrategy().select();
        this.redisSingleEventExecutor=new NioEventLoopGroup(1);
    }
    public WedisServerImp(LocalChannelOption channelOption)
    {
    ...
    {
        new WedisServerImp(new SingleSelectChannelOption()).start();
    }
